                      ...
                      {day && (
                          <button
                              className={`w-8 h-8 rounded-full text-sm hover:bg-gray-100 ${
                                  day === 27 ? 'bg-blue-900 text-white hover:bg-blue-800' : ''
                              }`}
                          >
                            {day}
                          </button>
                              ...
                              {index === 2 && (
                                  <>
                                    <div className="bg-orange-50 rounded-lg p-3 flex items-center space-x-2">
                                      <div className="w-4 h-4 bg-orange-400 rounded"></div>
                                      <span className="text-sm">12:00 PM - 1:00PM</span>
                                      <span className="text-sm font-medium">Call Tina at Starbucks regarding Reem Hills Property</span>
                                      <ChevronRight className="w-4 h-4 ml-auto" />
                                    </div>
                                    <div className="bg-purple-100 rounded-lg p-3 flex items-center space-x-2">
                                      <div className="w-4 h-4 bg-purple-400 rounded"></div>
                                      <span className="text-sm">2:00 PM - 4:00PM</span>
                                      <span className="text-sm font-medium">Send Reem Hills Property to Kevin</span>
                                      <ChevronRight className="w-4 h-4 ml-auto" />
                                    </div>
                                  </>
                              )}
