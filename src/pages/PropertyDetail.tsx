              ...
              <CardContent className="p-8">
                ...
                <div className="mb-6">
                  ...
                  <p className="text-gray-600 text-sm">
                    ...
                    Properties, situated in the scenic Reem Hills community on
                    Al Reem Island, Abu Dhabi. This project is designed to offer
                    a harmonious blend of modern living amidst natural beauty,
                    with a focus on minimalist architecture and
