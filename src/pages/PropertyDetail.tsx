...
import { Calendar, MessageSquare, Heart, UserPlus, Home, Search, ArrowRight, Bed, Bath, Square, Zap, Snowflake, Grid, Plus } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto px-6 py-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <CardContent className="p-6">
                ...
                <div className="mb-6">
                  ...
                  <p className="text-gray-600 text-sm">
                    Amara Reem Hills is an upcoming residential development by Q Properties, situated in the scenic Reem Hills community 
          ...
          <div className="space-y-6">
            ...
            <Card>
              <CardHeader>
                <CardTitle className="text-lg font-bold text-gray-900">Property Information</CardTitle>
              </CardHeader>
            ...
            <Card>
              <CardHeader>
                <CardTitle className="text-lg font-bold text-gray-900">Amenities and Features</CardTitle>
              </CardHeader>
              <CardContent>
                ...
                <Button variant="outline" className="w-full text-blue-900 border-blue-900 hover:bg-blue-50">
                  +11 more amenities
                </Button>
              </CardContent>
            </Card>
