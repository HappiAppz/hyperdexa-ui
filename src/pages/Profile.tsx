    ...
    <Layout>
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6">
          ...
          <Card className="bg-gradient-to-b from-gray-700 to-gray-800 text-white">
            <CardContent className="p-4 sm:p-6 text-center">
              <Avatar className="w-24 h-24 sm:w-32 sm:h-32 mx-auto mb-4">
                ...
                <AvatarFallback className="text-xl sm:text-2xl bg-gray-600">
                  {profileData.name
                    .split(" ")
                    .map((n) => n[0])
                    .join("")}
              ...
              <div className="space-y-3">
                <a
                  ...
                  className="flex items-center justify-center space-x-2 bg-white/10 rounded-lg px-4 py-3 hover:bg-white/20 transition-colors touch-manipulation"
                >
        ...
        <div className="lg:col-span-1 space-y-4 sm:space-y-6">
          ...
          <Card>
            <CardContent className="p-4 sm:p-6">
              <h3 className="text-base sm:text-lg font-semibold text-[#1e3a8a] mb-4">
                Listing Snapshot
              </h3>
              <div className="relative rounded-lg overflow-hidden">
                ...
                <button className="absolute top-3 right-3 w-8 h-8 bg-white rounded-full flex items-center justify-center hover:bg-gray-100 transition-colors touch-manipulation">
                ...
                <button className="absolute bottom-4 right-4 w-10 h-10 bg-white rounded-full flex items-center justify-center hover:bg-gray-100 transition-colors touch-manipulation">
          ...
          <Card>
            <CardContent className="p-4 sm:p-6">
              <div className="flex items-center justify-between mb-4">
                ...
                <button className="w-8 h-8 rounded-full bg-gray-100 flex items-center justify-center hover:bg-gray-200 transition-colors touch-manipulation">
              ...
              <div className="space-y-3">
                {followUps.map((followUp, index) => (
                  <div key={index} className="border rounded-lg p-3">
                    ...
                    <Button className="w-full bg-white text-[#1e3a8a] border border-[#1e3a8a] hover:bg-[#1e3a8a] hover:text-white transition-colors text-sm">
                      Message now
                    </Button>
                  </div>
                ))}
              </div>
              <Button className="w-full mt-4 bg-white text-[#1e3a8a] border border-[#1e3a8a] hover:bg-[#1e3a8a] hover:text-white transition-colors text-sm">
                Show all follow ups
              </Button>
            </CardContent>
          </Card>
