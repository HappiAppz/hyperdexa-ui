...
const LeadDetail = () => {
  ...
  const activityLog = [
    ...
    { time: '10:15', action: 'You send reem hills listing', day: 'Yesterday' },
    { time: '10:15', action: 'You send reem hills listing', day: 'Yesterday' },
    { time: '10:15', action: 'You send reem hills listing', day: '25 June, Thursday' },
    { time: '10:15', action: 'You send reem hills listing', day: '25 June, Thursday' },
    { time: '10:15', action: 'You send reem hills listing', day: '25 June, Thursday' }
  ];
        ...
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center space-x-6">
            ...
            <div className="flex items-center space-x-2 text-gray-500">
              ...
              <span>→</span>
              <span className="text-gray-900 font-semibold">Josephine Gordon</span>
            </div>
          </div>
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white rounded-2xl p-6 border border-gray-200">
              <div className="flex items-center justify-between mb-4">
                <h2 className="text-2xl font-bold text-gray-900">Josephine Gordon</h2>
            ...
            <div className="bg-white rounded-2xl p-6 border-2 border-blue-200">
              <h3 className="text-xl font-bold text-gray-900 mb-6">Matched Properties</h3>
                ...
                {matchedProperties.map((property) => (
                  ...
                  >
                    ...
                    <div className="p-4">
                      ...
                      <div className="text-xs text-gray-600 mb-1">{property.company}</div>
